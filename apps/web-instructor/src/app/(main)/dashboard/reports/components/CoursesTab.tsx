...
function PieChartCard({ data }: { data: { name?: string; status?: string; level?: string; count: number }[] }) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-[var(--card-background)] rounded-xl border border-gray-200 dark:border-[var(--card-border)] shadow-sm p-4">
          ...
          <PieChartCard data={courses.courseStatusDistribution.map(d => ({ status: d.status, count: d.count }))} />
        </div>
        <div className="bg-white dark:bg-[var(--card-background)] rounded-xl border border-gray-200 dark:border-[var(--card-border)] shadow-sm p-4">
          <div className="flex items-center justify-between mb-2">
          ...
          <PieChartCard data={courses.categoryDistribution.map(d => ({ name: d.name, count: d.count }))} />
        </div>
        <div className="bg-white dark:bg-[var(--card-background)] rounded-xl border border-gray-200 dark:border-[var(--card-border)] shadow-sm p-4">
          <div className="flex items-center justify-between mb-2">
          ...
          <PieChartCard data={courses.difficultyDistribution.map(d => ({ level: d.level, count: d.count }))} />
        </div>
      </div>
