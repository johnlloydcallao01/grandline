...
export default function CreateQuestionPage() {
    ...
    const handleSave = async (payload: Record<string, any>) => {
        try {
            ...
            setSaveSuccess(true);
            setTimeout(() => router.push(`/courses/questions/${created.id}/edit` as any), 800);
        } catch (err: any) {
        ...
        <div className="py-6 w-full">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create Question</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Add a new question to the question bank</p>
                    </div>
                </div>
