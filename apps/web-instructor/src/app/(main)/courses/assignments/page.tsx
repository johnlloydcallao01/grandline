...
export default function AssignmentsPage() {
    ...
    const metricCards = [
        { label: 'Total Assignments', value: totalDocs, color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-950/30', icon: BookOpenIcon },
        { label: 'File Upload', value: typeCounts.file_upload, color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-950/30', icon: FileTextIcon },
        { label: 'Text Entry', value: typeCounts.text_entry, color: 'text-green-600 dark:text-green-400', bg: 'bg-green-50 dark:bg-green-950/30', icon: FileTextIcon },
        { label: 'Both', value: typeCounts.both, color: 'text-purple-600 dark:text-purple-400', bg: 'bg-purple-50 dark:bg-purple-950/30', icon: FileTextIcon },
    ];
