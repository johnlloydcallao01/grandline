...
export function CourseCategoryCircle({
  ...
  return (
    ...
    >
      <div
        className={`w-16 h-16 rounded-full flex items-center justify-center transition-all duration-200 overflow-hidden bg-gray-100 dark:bg-gray-800 relative ${active
            ? 'scale-110 shadow-lg ring-2 ring-gray-300 dark:ring-gray-600'
      ...
      <span
        className={`text-xs font-medium transition-colors text-center leading-tight ${active
