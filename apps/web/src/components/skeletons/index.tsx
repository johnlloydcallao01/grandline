    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-[var(--card-background)] rounded-lg border border-[var(--card-border)] p-6">
          <div className="h-5 bg-gray-200 dark:bg-gray-700 rounded w-1/3 animate-pulse mb-4"></div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className="flex flex-col items-end gap-1 w-40">
              ...
              <div className="w-full h-1.5 rounded-full bg-gray-100 dark:bg-gray-800 overflow-hidden">
                <div className="h-full bg-gray-200 dark:bg-gray-700 animate-pulse w-1/3"></div>
              </div>
            </div>
             {/* Status Badge */}
           ...
           {/* Mobile Menu Button */}
           <div className="lg:hidden w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
        </div>
      </header>
...
export function ListPageSkeleton() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
      ...
      {/* List Items Skeleton */}
      <div className="bg-[var(--card-background)] rounded-lg border border-[var(--card-border)] divide-y divide-[var(--card-border)]">
        {Array.from({ length: 8 }).map((_, index) => (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
      ...
      <div className="bg-[var(--card-background)] rounded-lg border border-[var(--card-border)]">
        ...
        {Array.from({ length: 5 }).map((week, weekIndex) => (
          <div key={weekIndex} className="grid grid-cols-7 border-b border-[var(--card-border)] last:border-b-0">
            {Array.from({ length: 7 }).map((_, dayIndex) => (
              <div key={dayIndex} className="p-4 h-24 border-r border-[var(--card-border)] last:border-r-0">
                <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-6 animate-pulse mb-2"></div>
