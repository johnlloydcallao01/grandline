    ...
    <div className="min-h-screen bg-[var(--background)] pb-12">
      <div className="bg-[var(--card-background)] border-b border-[var(--card-border)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="animate-pulse h-8 bg-gray-200 dark:bg-gray-800 rounded w-1/3 mb-2"></div>
          <div className="animate-pulse h-4 bg-gray-200 dark:bg-gray-800 rounded w-1/4"></div>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="animate-pulse h-[600px] bg-gray-200 dark:bg-gray-800 rounded-xl w-full"></div>
      </div>
    </div>
  );
}