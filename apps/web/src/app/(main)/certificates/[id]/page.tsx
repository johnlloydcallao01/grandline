...
function ErrorState({ message }: { message: string }) {
  return (
    <div className="min-h-screen bg-[var(--background)] p-6 flex items-center justify-center">
      <div className="bg-[var(--card-background)] p-8 rounded-2xl shadow-sm border border-red-100 dark:border-red-900/50 max-w-md w-full text-center">
        ...
        <Link 
          href="/certificates"
          className="block w-full bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 font-medium py-3 rounded-xl hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
        >
