          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between py-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Manage and track your STCW and professional maritime certifications.
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-3">
              ...
              <select className="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-lg">
                ...
                <option>Sort by: Issue Date</option>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-xs text-gray-500 font-mono">{cert.number}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{cert.authority}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500">{cert.issueDate}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-medium">{cert.expiryDate}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
