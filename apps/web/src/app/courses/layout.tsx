  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-[var(--background)] flex flex-col relative">
        <div className="lg:hidden sticky top-0 z-30 bg-[var(--card-background)] border-b border-[var(--card-border)]">
          <div className="h-14 px-2.5 flex items-center gap-2">
            <button
              type="button"
              aria-label="Go back"
              onClick={() => router.back()}
              className="inline-flex w-8 h-8 items-center justify-center rounded-full bg-[var(--card-background)] text-gray-700 dark:text-gray-300 shadow-md border border-[var(--card-border)]"
            >
