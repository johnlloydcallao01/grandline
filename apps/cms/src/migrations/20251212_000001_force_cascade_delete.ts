...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  await db.execute(sql`
    ...
    ALTER TABLE IF EXISTS "admins" ADD CONSTRAINT "admins_user_id_users_id_fk" 
    FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") 
    ON DELETE CASCADE ON UPDATE NO ACTION;

    -- 2. Trainees
    ALTER TABLE IF EXISTS "trainees" DROP CONSTRAINT IF EXISTS "trainees_user_id_users_id_fk";
    ALTER TABLE IF EXISTS "trainees" ADD CONSTRAINT "trainees_user_id_users_id_fk" 
    FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") 
    ON DELETE CASCADE ON UPDATE NO ACTION;

    -- 3. Instructors
    ALTER TABLE IF EXISTS "instructors" DROP CONSTRAINT IF EXISTS "instructors_user_id_users_id_fk";
    ALTER TABLE IF EXISTS "instructors" ADD CONSTRAINT "instructors_user_id_users_id_fk" 
    FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") 
    ON DELETE CASCADE ON UPDATE NO ACTION;
    ...
    ALTER TABLE IF EXISTS "user_certifications" ADD CONSTRAINT "user_certifications_user_id_users_id_fk" 
    FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") 
    ON DELETE CASCADE ON UPDATE NO ACTION;

    -- 5. Emergency Contacts
    ALTER TABLE IF EXISTS "emergency_contacts" DROP CONSTRAINT IF EXISTS "emergency_contacts_user_id_users_id_fk";
    ALTER TABLE IF EXISTS "emergency_contacts" ADD CONSTRAINT "emergency_contacts_user_id_users_id_fk" 
    FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") 
    ON DELETE CASCADE ON UPDATE NO ACTION;

    -- 6. Recent Searches
    ALTER TABLE IF EXISTS "recent_searches" DROP CONSTRAINT IF EXISTS "recent_searches_user_id_users_id_fk";
    ALTER TABLE IF EXISTS "recent_searches" ADD CONSTRAINT "recent_searches_user_id_users_id_fk" 
    FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") 
    ON DELETE CASCADE ON UPDATE NO ACTION;

    -- 7. User Events (Owner)
    ALTER TABLE IF EXISTS "user_events" DROP CONSTRAINT IF EXISTS "user_events_user_id_users_id_fk";
    ALTER TABLE IF EXISTS "user_events" ADD CONSTRAINT "user_events_user_id_users_id_fk" 
    FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") 
    ON DELETE CASCADE ON UPDATE NO ACTION;
  `)
}
