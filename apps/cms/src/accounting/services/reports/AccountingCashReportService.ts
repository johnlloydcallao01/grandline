  ...
  static async getCashActivity(payload: Payload) {
    ...
    const rows: AccountingCashActivityRow[] = [
      ...paymentsReceived.map((payment) => ({
        ...
        bankAccountName:
          typeof payment.depositAccount === 'object' ? payment.depositAccount.accountName || null : null,
      ...
      ...paymentsMade.map((payment) => ({
        ...
        bankAccountName: typeof payment.bankAccount === 'object' ? payment.bankAccount.accountName || null : null,
      ...
      ...expenses.map((expense) => ({
        ...
        bankAccountName: typeof expense.bankAccount === 'object' ? expense.bankAccount.accountName || null : null,
        direction: 'outflow' as const,
      ...
      ...deposits.map((deposit) => ({
        ...
        bankAccountName: typeof deposit.bankAccount === 'object' ? deposit.bankAccount.accountName || null : null,
        direction: 'inflow' as const,
      ...
      ...transfers.map((transfer) => ({
        ...
        bankAccountName:
          typeof transfer.toBankAccount === 'object' ? transfer.toBankAccount.accountName || null : null,
