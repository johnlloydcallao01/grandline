...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    if ('expenseAccount' in body) data.expenseAccount = body.expenseAccount || null
    if ('assetAccount' in body) data.assetAccount = body.assetAccount || null
    if ('accumulatedDepreciationAccount' in body) data.accumulatedDepreciationAccount = body.accumulatedDepreciationAccount || null
    if ('branch' in body) data.branch = body.branch || null
