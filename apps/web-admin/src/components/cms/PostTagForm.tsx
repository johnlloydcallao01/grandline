...
export default function PostTagForm({
    ...
    return (
        <form id="tag-form" onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="contents">
                ...
                <div className="bg-white dark:bg-[var(--card-background)] rounded-xl border border-gray-200 dark:border-[var(--card-border)] shadow-sm p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" value={form.name}
                            ...
                            placeholder="e.g. Maritime Safety, Navigation, STCW" />
                    </div>
                    <div>
            ...
            <div className="space-y-6">
                <div className="bg-white dark:bg-[var(--card-background)] rounded-xl border border-gray-200 dark:border-[var(--card-border)] shadow-sm p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Hex color for tag theming</p>
                    </div>
                    <div>
                ...
                {mode === 'edit' && tag && (
                    <div className="bg-white dark:bg-[var(--card-background)] rounded-xl border border-gray-200 dark:border-[var(--card-border)] shadow-sm p-6 space-y-3">
                        ...
                        <div>
                            <span className="text-xs text-gray-500 dark:text-gray-400">Slug</span>
                            <p className="text-sm text-gray-900 dark:text-gray-100 font-medium font-mono text-xs mt-1">{tag.slug}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            <span className="text-xs text-gray-500 dark:text-gray-400">Tag ID</span>
                            <p className="text-xs text-gray-400 dark:text-gray-500 font-mono break-all bg-gray-50 dark:bg-gray-800 p-2 rounded mt-1">{tagId}</p>
                        </div>
                    </div>
                )}
            </div>
            ...
            {saveSuccess && (
                <div className="lg:col-span-3 fixed top-4 left-1/2 -translate-x-1/2 z-50">
                    <div className="bg-green-600 text-white px-5 py-3 rounded-lg shadow-lg flex items-center gap-2.5 text-sm font-medium">
                        ...
                        {mode === 'create' ? 'Tag created successfully — redirecting...' : 'Tag saved successfully'}
