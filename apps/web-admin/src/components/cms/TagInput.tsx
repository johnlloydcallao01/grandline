    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div
        ...
        className={`
          ...
          ${isInputFocused 
            ? 'border-blue-500 dark:border-blue-400 ring-1 ring-blue-500 dark:ring-blue-400/30' 
            : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'
          }
          ${value.length >= maxTags ? 'bg-gray-50 dark:bg-gray-800' : 'bg-white dark:bg-[var(--card-background)]'}
        `}
      >
          ...
          {value.map((tag, index) => (
            ...
            >
              ...
              <button
                ...
                className="ml-1 inline-flex items-center justify-center w-4 h-4 rounded-full hover:bg-blue-200 dark:hover:bg-blue-800 focus:outline-none"
              >
                <X className="w-3 h-3" />
              </button>
            </span>
      ...
      {isInputFocused && inputValue && (
        <div className="border border-gray-200 dark:border-[var(--card-border)] rounded-md bg-white dark:bg-[var(--card-background)] shadow-sm">
          <div className="p-2">
            <button
              type="button"
              onClick={() => addTag(inputValue)}
              className="w-full flex items-center px-2 py-1 text-sm text-left hover:bg-gray-50 dark:hover:bg-gray-800 rounded text-gray-900 dark:text-gray-100"
            >
              <Plus className="w-4 h-4 mr-2 text-gray-400 dark:text-gray-500" />
              Add &quot;{inputValue}&quot;
            </button>
          </div>
        </div>
