...
export const CheckCheck = createIconWrapper(LucideIcons.CheckCheck);
export const Smile = createIconWrapper(LucideIcons.Smile);
export const Paperclip = createIconWrapper(LucideIcons.Paperclip);
