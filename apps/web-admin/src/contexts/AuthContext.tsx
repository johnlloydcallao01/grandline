  ...
  const initializeAuth = useCallback(async () => {
    ...
    try {
      ...
      if (initialUser && initialToken) {
        try {
          localStorage.setItem('grandline_auth_user_admin', JSON.stringify(initialUser));
          localStorage.setItem('grandline_auth_token_admin', initialToken);
        } catch { void 0; }
      ...
      try {
        ...
        cachedToken = localStorage.getItem('grandline_auth_token_admin');
        if (cached) {
