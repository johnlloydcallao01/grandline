...
function SkeletonRow(_props: Record<string, unknown>) {
  return (
    <tr className="animate-pulse">
      <td className="px-4 py-3"><div className="flex items-center gap-3"><div className="h-8 w-8 rounded bg-gray-100" /><div className="h-4 bg-gray-100 rounded w-44" /></div></td>
      <td className="px-4 py-3"><div className="h-4 bg-gray-100 rounded w-12" /></td>
      <td className="px-4 py-3"><div className="h-2 bg-gray-100 rounded w-full" /></td>
    </tr>
  )
}
    ...
    return (
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-100">
          <h3 className="text-sm font-semibold text-gray-900">Popular Courses</h3>
        </div>
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
        <h3 className="text-sm font-semibold text-gray-900">Popular Courses</h3>
        <span className="text-xs text-gray-400">By enrollment</span>
      </div>
          ...
          return (
            <div key={course.id} className="px-4 py-3 hover:bg-gray-50/50 transition-colors">
              <div className="flex items-center gap-3 mb-1.5">
                ...
                <span className="text-xs font-semibold text-gray-600 tabular-nums">{course.enrollmentCount}</span>
              </div>
