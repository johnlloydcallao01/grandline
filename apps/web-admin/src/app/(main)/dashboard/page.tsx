...
function DashboardSkeleton() {
  return (
    <div className="py-4 sm:py-6 space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 [&>:last-child:nth-child(odd)]:col-span-full lg:[&>:last-child:nth-child(odd)]:col-span-1">
