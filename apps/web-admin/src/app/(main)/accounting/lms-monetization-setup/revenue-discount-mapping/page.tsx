      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Revenue & Discount Mapping</h1>
              <p className="mt-1 max-w-3xl text-sm text-gray-600">Review LMS revenue account mappings, coupon and discount definitions, and deferred recognition schedules tied to enrollment monetization.</p>
            </div>
          </div>
        </div>
      </div>
