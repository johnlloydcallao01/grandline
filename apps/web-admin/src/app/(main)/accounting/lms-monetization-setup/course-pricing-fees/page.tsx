...
export default function CoursePricingFeesPage() {
  ...
  return (
    <div className="space-y-6 p-[10px]">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Course Pricing & Fees</h1>
              <p className="mt-1 max-w-3xl text-sm text-gray-600 dark:text-gray-400">
                Review course fee profiles and monetization component settings that drive LMS pricing overlays, recognition defaults, and accounting mapping.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-6">
        {activeTab === 'course-fee-profiles' && <CoursePricingClient />}
        {activeTab === 'fee-components-recognition' && <FeeComponentsClient />}
      </div>
    </div>
  );
}
