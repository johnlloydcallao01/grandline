      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-[var(--card-border)] dark:bg-[var(--card-background)]">
        <div className="flex flex-col gap-4 border-b border-gray-200 px-5 py-4 lg:flex-row lg:items-center lg:justify-between dark:border-[var(--card-border)]">
          <div className="flex flex-1 flex-col gap-3 lg:flex-row lg:items-center">
            <div className="relative min-w-0 max-w-xl flex-1">
              ...
              <input type="text" placeholder={tab.searchPlaceholder} className="w-full rounded-lg border border-gray-300 bg-white py-2.5 pl-10 pr-4 text-sm text-gray-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:border-gray-600 dark:bg-[var(--card-background)] dark:text-gray-100 dark:focus:border-blue-600 dark:focus:ring-blue-900/50" />
            </div>
            <button type="button" className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:bg-[var(--card-background)] dark:text-gray-300 dark:hover:bg-gray-800">
          ...
          <div className="flex flex-wrap gap-2">
            {tab.quickFilters.map((filter, index) => (
              <button key={filter} type="button" className={`rounded-full px-3 py-1.5 text-xs font-medium transition-colors ${index === 0 ? 'bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-200 dark:bg-blue-950/30 dark:text-blue-400 dark:ring-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700'}`}>
                {filter}
              </button>
            ))}
          </div>
        ...
        <div className="space-y-4 p-[10px] sm:p-5">
          <div className="flex items-start justify-between gap-3">
            ...
            <button type="button" className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:bg-[var(--card-background)] dark:text-gray-300 dark:hover:bg-gray-800">
                ...
                <thead className="bg-gray-50 dark:bg-gray-800/50">
                  <tr>
                    {tab.columns.map((column) => (
                      <th key={column} className={`px-4 py-3 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 ${column === 'Amount' || column === 'Exposure' ? 'text-right' : 'text-left'}`}>
                        {column}
                      </th>
                    ))}
                  ...
                  {tab.rows.map((row) => (
                    <tr key={row.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                      ...
                      <td className="px-4 py-3 text-right">
                        <button type="button" className="inline-flex items-center gap-1 rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-300">
...
function DepositsPanel() {
  ...
  const renderForm = (
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-[var(--card-border)] dark:bg-gray-800/50">
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Draft deposits can be reviewed and edited here, then posted later from the table using the dedicated Post action.</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 rounded-xl border border-gray-200 bg-gray-50 p-5 lg:flex-row lg:items-center lg:justify-between dark:border-[var(--card-border)] dark:bg-gray-800/50">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{data?.meta.label || 'Deposits'}</h2>
        ...
        <div className="flex flex-col gap-4 border-b border-gray-200 px-5 py-4 lg:flex-row lg:items-center lg:justify-between dark:border-[var(--card-border)]">
          <div className="flex flex-1 flex-col gap-3 lg:flex-row lg:items-center">
            <form onSubmit={handleSearch} className="flex min-w-0 max-w-xl flex-1 gap-3">
              ...
              <button type="submit" className="inline-flex items-center gap-2 rounded-lg border border-blue-600 bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:border-blue-700 hover:bg-blue-700 dark:border-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800">
        ...
        <div className="space-y-4 p-[10px] sm:p-5">
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-[var(--card-border)] dark:bg-gray-800/50">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Select as many filter values as needed. Deposits filters widen results using OR behavior across all checked options.</p>
                </div>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button type="button" onClick={() => { setFilters({ ...draftFilters }); setCurrentPage(1); setIsFilterPanelOpen(false); }} className="rounded-lg border border-blue-600 bg-blue-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700 dark:border-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800">
                    Apply Filters
                  </button>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
            <div className="space-y-2">
              <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">{data?.meta.tableTitle || 'Deposit Register'}</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">{data?.meta.tableDescription || 'Live register of deposit records and their posting progress.'}</p>
            </div>
      ...
      <SlideOver isOpen={isPostOpen} onClose={() => setIsPostOpen(false)} title="Post Deposit Batch" description="Post this draft deposit into journals using the existing accounting banking service.">
        <div className="space-y-6">
          ...
          {postTarget ? (
            <>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-[var(--card-border)] dark:bg-[var(--card-background)]">
                <div className="flex justify-between border-b border-gray-100 pb-3 dark:border-gray-800">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Deposit Batch</span>
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{postTarget.depositNumber}</span>
                </div>
                <div className="mt-3 flex justify-between border-b border-gray-100 pb-3 dark:border-gray-800">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{postTarget.bankAccountLabel}</span>
                </div>
                <div className="mt-3 flex justify-between border-b border-gray-100 pb-3 dark:border-gray-800">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Source Account</span>
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{postTarget.sourceAccountLabel}</span>
                </div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Loading deposit detail...</p>
          )}

          <div className="flex items-center justify-end gap-3 border-t border-gray-200 pt-4 dark:border-[var(--card-border)]">
            <button type="button" onClick={() => setIsPostOpen(false)} disabled={isPostSubmitting} className="rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 disabled:opacity-50 dark:text-gray-300 dark:hover:bg-gray-800">
              Cancel
            </button>
            <button type="button" onClick={handleConfirmPost} disabled={isPostSubmitting || !postTarget?.usageSummary.canPost} className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50 dark:bg-blue-700 dark:hover:bg-blue-800">
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Cash Movement</h1>
              <p className="mt-1 max-w-3xl text-sm text-gray-600 dark:text-gray-400">Manage deposits, internal transfers, undeposited funds, and bounced payment exceptions in one cash-movement workspace.</p>
            </div>
          </div>
        </div>
      </div>
