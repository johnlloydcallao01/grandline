      ...
      >
        <div className="space-y-6">
          {isDetailLoading ? (
            ...
            <>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">Primary Allowed</p>
                    <p className="mt-2 text-sm font-medium text-gray-900">{detail.canBePrimary ? 'Yes' : 'No'}</p>
                  </div>
                  <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">Receipt Oriented</p>
                    <p className="mt-2 text-sm font-medium text-gray-900">{detail.receiptOriented ? 'Yes' : 'No'}</p>
                  </div>
                </div>
                <div className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">Entity Coverage</p>
                  <p className="mt-2 text-sm font-medium text-gray-900">{detail.entityCoverageSummary}</p>
                </div>
                <div className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                <h4 className="text-sm font-semibold text-gray-900">Recent Linked Records</h4>
                <p className="mt-1 text-sm text-gray-600">
            ...
            <p className="text-sm text-gray-500">No category detail available.</p>
          )}
        </div>
      </SlideOver>
    </div>
