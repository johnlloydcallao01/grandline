      ...
      >
        <div className="space-y-6">
          {isDetailLoading ? (
            ...
            <>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                ...
                <div className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">Active Entity IDs</p>
                  <p className="mt-2 text-sm font-medium text-gray-900">{detail.activeEntityIdSummary}</p>
                </div>
                <div className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
            ...
            <p className="text-sm text-gray-500">No entity link detail available.</p>
          )}
        </div>
      </SlideOver>
    </div>
