...
function getActionClasses(variant: 'primary' | 'secondary' | 'ghost' = 'secondary') {
  if (variant === 'primary') return 'border border-blue-600 bg-blue-600 dark:bg-blue-700 dark:border-blue-700 text-white hover:bg-blue-700 hover:border-blue-700';
...
function SlideOver({
  ...
  return createPortal(
    ...
    >
      <div
        className={`flex w-full max-w-lg flex-col bg-white dark:bg-[var(--card-background)] shadow-xl transition-all duration-300 ease-in-out ${animate ? 'translate-x-0' : 'translate-x-full'}`}
      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-[var(--card-border)]">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
            ...
            <tbody className="divide-y divide-gray-200 bg-white dark:bg-[var(--card-background)]">
    ...
    <div className="space-y-6 p-[10px]">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold text-gray-900 dark:text-gray-100">Audit Logs</h1>
              ...
              <div className="space-y-4 p-[10px] sm:p-5">
                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <button
                          ...
                          className="rounded-lg border border-blue-600 bg-blue-600 dark:bg-blue-700 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700"
                        >
                          Apply Filters
                        </button>
                      </div>
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  <div className="space-y-2">
                    <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">Finance Audit Trail</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Audit visibility across finance entities, performers, control actions, reasons, and payload context.</p>
                  </div>
                ...
                {viewDetail ? (
                  <>
                    <div className="space-y-4 rounded-xl border border-gray-200 dark:border-[var(--card-border)] bg-white dark:bg-[var(--card-background)] p-5 shadow-sm">
                      <div className="flex justify-between border-b border-gray-100 dark:border-gray-800 pb-3"><span className="text-sm text-gray-500 dark:text-gray-400">Performed At</span><span className="text-sm font-medium text-gray-900 dark:text-gray-100">{viewDetail.performedAtLabel}</span></div>
                      <div className="flex justify-between border-b border-gray-100 dark:border-gray-800 pb-3"><span className="text-sm text-gray-500 dark:text-gray-400">Entity Type</span><span className="text-sm font-medium text-gray-900 dark:text-gray-100">{viewDetail.entityTypeLabel}</span></div>
                      <div className="flex justify-between border-b border-gray-100 dark:border-gray-800 pb-3"><span className="text-sm text-gray-500 dark:text-gray-400">Entity ID</span><span className="text-sm font-medium text-gray-900 dark:text-gray-100">{viewDetail.entityId}</span></div>
                      <div className="flex justify-between border-b border-gray-100 dark:border-gray-800 pb-3"><span className="text-sm text-gray-500 dark:text-gray-400">Action</span><span className="text-sm font-medium text-gray-900 dark:text-gray-100">{viewDetail.actionLabel}</span></div>
                      <div className="flex justify-between border-b border-gray-100 dark:border-gray-800 pb-3"><span className="text-sm text-gray-500 dark:text-gray-400">Performed By</span><span className="text-sm font-medium text-gray-900 dark:text-gray-100">{viewDetail.performedBy}</span></div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <pre className="mt-2 overflow-x-auto rounded-xl border border-gray-200 dark:border-[var(--card-border)] bg-gray-50 dark:bg-gray-800/50 p-4 text-xs text-gray-700 dark:text-gray-300">{formatJsonValue(viewDetail.metadata)}</pre>
                      </div>
                      <div>
                        <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Before Data</h4>
                        <pre className="mt-2 overflow-x-auto rounded-xl border border-gray-200 dark:border-[var(--card-border)] bg-gray-50 dark:bg-gray-800/50 p-4 text-xs text-gray-700 dark:text-gray-300">{formatJsonValue(viewDetail.beforeData)}</pre>
                      </div>
                      <div>
                        <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">After Data</h4>
                        <pre className="mt-2 overflow-x-auto rounded-xl border border-gray-200 dark:border-[var(--card-border)] bg-gray-50 dark:bg-gray-800/50 p-4 text-xs text-gray-700 dark:text-gray-300">{formatJsonValue(viewDetail.afterData)}</pre>
                      </div>
                    </div>
                  </>
                ) : (
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-gray-200 dark:border-[var(--card-border)] bg-white dark:bg-[var(--card-background)] shadow-sm">
              ...
              <div className="space-y-4 p-[10px] sm:p-5">
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  <div className="space-y-2">
                    <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">{exportData?.section.table.title || 'Export Audit Events'}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">{exportData?.section.table.description || 'Audit-log entries for exported actions so outbound accounting data access remains visible.'}</p>
                  </div>
                  <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                    <span>{exportData?.totals.filteredRows ?? 0} matching rows</span>
                    <button type="button" onClick={handleExportActivityDownload} className="inline-flex items-center gap-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[var(--card-background)] px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-50" disabled={!(exportData?.section.table.rows.length)}>
                      <Download className="h-4 w-4" />
                      Download View
                    </button>
                  </div>
                ...
                {isLoading ? (
                  ...
                  <>
                    ...
                    {exportData?.pagination && exportData.pagination.totalPages > 1 ? (
                      <div className="flex items-center justify-between">
                        <p className="text-sm text-gray-600 dark:text-gray-400">Page {exportData.pagination.page} of {exportData.pagination.totalPages}</p>
                        <div className="flex gap-2">
                          <button
                            type="button"
