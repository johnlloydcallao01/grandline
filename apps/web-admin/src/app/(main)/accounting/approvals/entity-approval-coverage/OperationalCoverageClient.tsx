    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 rounded-xl border border-gray-200 dark:border-[var(--card-border)] bg-gray-50 dark:bg-gray-800/50 p-5 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Operational Coverage</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400">Review approval workflow mappings for operational entity types such as budgets, asset disposals, timesheets, and payroll runs.</p>
