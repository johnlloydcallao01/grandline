  ...
  return (
    <div className="space-y-6 p-[10px]">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          <p className="text-sm font-medium text-blue-600 dark:text-blue-400">Administration / Approval Configuration</p>
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Entity Approval Coverage</h1>
              <p className="mt-1 max-w-3xl text-sm text-gray-600 dark:text-gray-400">Review the entity types and their associated approval workflows configured in the accounting system.</p>
            </div>
          </div>
        </div>
      </div>
