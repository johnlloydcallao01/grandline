  ...
  return (
    <div className="space-y-6 p-[10px]">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          <p className="text-sm font-medium text-blue-600 dark:text-blue-400">Operations / Approvals</p>
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Workflow Management</h1>
              <p className="mt-1 max-w-3xl text-sm text-gray-600 dark:text-gray-400">Review approval workflow templates, step assignments, and active workflow coverage used by the accounting approval service.</p>
            </div>
          </div>
        </div>
      </div>
