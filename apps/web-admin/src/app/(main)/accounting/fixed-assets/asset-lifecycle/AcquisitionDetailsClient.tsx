      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Asset Lifecycle</h1>
        ...
        <div className="space-y-6">
          <div className="flex flex-col gap-4 rounded-xl border border-gray-200 dark:border-[var(--card-border)] bg-gray-50 dark:bg-gray-800/50 p-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-col gap-1">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{ACQ_TAB_CONFIG.label}</h2>
              <p className="text-sm text-gray-600 dark:text-gray-400">{ACQ_TAB_CONFIG.description}</p>
            ...
            <div className="space-y-4 p-[10px] sm:p-5">
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div className="space-y-2">
                  <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">{ACQ_TAB_CONFIG.tableTitle}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">{ACQ_TAB_CONFIG.tableDescription}</p>
                </div>
                        ...
                        <thead className="bg-gray-50 dark:bg-gray-800/50">
                          <tr>
                            {cols.map((column: string) => (
                              <th key={column} className={`px-4 py-3 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 ${column === 'Cost' ? 'text-right' : 'text-left'}`}>
                                {column}
                              </th>
                            ))}
