    ...
    <div className="space-y-6 p-[10px]">
      <div className="flex flex-col gap-4 rounded-xl border border-gray-200 bg-gray-50 p-5 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-semibold text-gray-900">Depreciation Entries</h2>
                            ...
                            <td className="px-4 py-3 text-right">
                              <div className="flex justify-end gap-2">
                                ...
                                {row.status === 'scheduled' ? (
                                  <button type="button" onClick={() => handlePost(row.id)} disabled={isPosting && postId === row.id} className="inline-flex items-center gap-1 rounded-lg p-2 text-blue-500 transition-colors hover:bg-blue-50 hover:text-blue-700 disabled:opacity-50" title="Post entry">
