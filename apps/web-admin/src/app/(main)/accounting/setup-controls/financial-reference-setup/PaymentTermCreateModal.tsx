    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-gray-200 dark:border-[var(--card-border)] px-6 py-4">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Create Payment Term</h2>
          <button
            type="button"
            onClick={handleClose}
        ...
        <div className="space-y-4 px-6 py-5">
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Due In Days</label>
            <input
              type="number"
              value={dueInDays}
