        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {isLoading ? (
            ...
            <div className="space-y-6">
              ...
              <section>
                <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-gray-500">Currency Information</h3>
              ...
              <section>
                <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-gray-500">Flags</h3>
                <div className="grid grid-cols-2 gap-4">
                ...
                <div className="rounded-lg border border-red-200 bg-red-50 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-red-800">Delete this currency?</p>
