...
type SetupBadgeTone = 'gray' | 'blue' | 'green' | 'amber' | 'red';
...
type SetupTableRow = {
  id: string;
  cells: SetupTableCell[];
};

export type SetupControlsTab = {
  id: string;
  label: string;
  description: string;
...
type SetupControlsPageProps = {
  eyebrow: string;
  title: string;
  description: string;
  tabs: SetupControlsTab[];
  headerActions?: SetupAction[];
};

function getActionIcon(icon?: SetupAction['icon']) {
  switch (icon) {
    case 'plus':
      return Plus;
    case 'upload':
...
function getActionClasses(variant: SetupAction['variant'] = 'secondary') {
  if (variant === 'primary') {
...
function getBadgeClasses(tone: SetupBadgeTone = 'gray') {
  switch (tone) {
    case 'blue':
...
function renderCell(cell: SetupTableCell, index: number) {
...
function MetricCard({ metric }: { metric: SetupMetric }) {
...
export function SetupControlsPage({
  eyebrow,
  title,
  description,
  tabs,
  headerActions,
}: SetupControlsPageProps) {
