  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[var(--card-background)] rounded-xl border border-gray-200 dark:border-[var(--card-border)] shadow-sm p-4">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Platform Metrics</h3>
            <span className="text-xs text-gray-400 dark:text-gray-500">Key indicators</span>
          </div>
          <div className="grid grid-cols-2 gap-4 mt-4">
            {[
              { label: 'Certificates Issued', value: overview.totalCertificates, color: 'bg-purple-500', icon: <Award className="w-4 h-4 text-purple-600 dark:text-purple-400" /> },
              { label: 'Assessments Taken', value: overview.totalAssessments, color: 'bg-orange-500', icon: <BarChart3 className="w-4 h-4 text-orange-600 dark:text-orange-400" /> },
              { label: 'Assignments Submitted', value: overview.totalAssignments, color: 'bg-teal-500', icon: <Activity className="w-4 h-4 text-teal-600 dark:text-teal-400" /> },
              { label: 'Avg Progress', value: overview.avgProgress, color: 'bg-pink-500', icon: <TrendingUp className="w-4 h-4 text-pink-600 dark:text-pink-400" /> },
            ].map(item => (
              <div key={item.label} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1.5 rounded-md bg-white dark:bg-[var(--card-background)] shadow-sm ring-1 ring-black/5">{item.icon}</div>
