...
export default function EditLessonPage() {
            ...
            <div className="p-6 space-y-6 animate-pulse">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div><div className="h-6 bg-gray-100 rounded w-48" /><div className="h-4 bg-gray-100 rounded w-24 mt-1.5" /></div>
                    </div>
        ...
        return (
            <div className="p-6 flex items-center justify-center min-h-[400px]">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-gray-500 mb-6">This lesson does not exist or has been removed.</p>
                    <Link href="/courses/lessons" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">
            ...
            <div className="p-6 flex items-center justify-center min-h-[400px]">
                <div className="text-center max-w-md">
                    ...
                    <div className="flex gap-3 justify-center">
                        <button onClick={loadLesson} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">Retry</button>
                        <Link href="/courses/lessons" className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm font-medium">Back</Link>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="p-6 w-full">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/courses/lessons" className="p-2 rounded-lg hover:bg-gray-100 text-gray-500">
                ...
                <div className="flex items-center gap-3">
                    <Link href="/courses/lessons" className="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50">Cancel</Link>
