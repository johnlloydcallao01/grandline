import type { ProfilePicture, User } from '@/types/auth';
...
function sanitizeProfilePicture(value: unknown): ProfilePicture | null {
  ...
  return {
    ...
    cloudinaryURL: optionalString(source.cloudinaryURL),
  };
}
