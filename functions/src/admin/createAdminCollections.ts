 ...
 */
export async function createAdminCollections() {
  try {
 ...
 */
async function createDefaultRoles(batch: admin.firestore.WriteBatch) {
 ...
 */
async function createDefaultPermissions(batch: admin.firestore.WriteBatch) {
  ...
  for (const category of categories) {
    const actions = categoryActions[category as keyof typeof categoryActions];
 ...
 */
export async function createSuperAdmin(email: string, uid: string, displayName: string) {
  try {
