...
// ============================================================================
export function getChatChannelName(chatId) {
    return `chat:${chatId}`;
}
export function getMessagesChannelName(chatId) {
    return `chat:${chatId}:messages`;
}
export function getTypingChannelName(chatId) {
...
export class ChatChannelManager {
    ...
    // Channel Management
    // ==========================================================================
    subscribeToChat(chatId, handler) {
    ...
    unsubscribeFromChat(chatId, handler) {
        const channelName = getChatChannelName(chatId);
        if (handler) {
    ...
    setTyping(chatId, userId, isTyping, debounceMs = 3000) {
        const key = chatId;
