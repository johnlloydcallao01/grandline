...
export type RealtimeEventType = 'message_insert' | 'message_update' | 'message_delete' | 'status_update' | 'typing_update' | 'reaction_insert' | 'reaction_delete';
...
export type ChatEventPayload = {
    ...
    type: 'typing_update';
    payload: ChatTypingStatus;
} | {
    type: 'reaction_insert';
    payload: {
        messageId: number;
