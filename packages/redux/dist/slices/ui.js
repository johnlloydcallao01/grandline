...
const uiSlice = createSlice({
    ...
    reducers: {
        ...
        clearNotificationsByType: (state, action) => {
            state.notifications = state.notifications.filter(notification => notification.type !== action.payload);
        },
        ...
        updateModalOptions: (state, action) => {
...
export const showSuccessNotification = (message, title) => uiSlice.actions.addNotification({
    type: 'success',
    title: title || 'Success',
    message,
    duration: 4000,
...
export const showErrorNotification = (message, title) => uiSlice.actions.addNotification({
    type: 'error',
    title: title || 'Error',
    message,
    duration: 6000,
...
export const showWarningNotification = (message, title) => uiSlice.actions.addNotification({
    type: 'warning',
    title: title || 'Warning',
    message,
    duration: 5000,
...
export const showInfoNotification = (message, title) => uiSlice.actions.addNotification({
    type: 'info',
...
export const showActionNotification = (message, actions, title, type = 'info') => uiSlice.actions.addNotification({
    type,
...
export const showLoadingWithTimeout = (key, timeout = 30000) => (dispatch) => {
...
// ============================================================================
export const { setTheme, toggleTheme, setSidebarOpen, toggleSidebar, setMobileMenuOpen, toggleMobileMenu, addNotification, removeNotification, clearNotifications, clearNotificationsByType, updateNotification, openModal, closeModal, closeAllModals, updateModalData, updateModalOptions, setGlobalLoading, setLoading, clearLoading, clearAllLoading, setGlobalError, setError, clearError, clearAllErrors, resetUI, batchUIUpdates, } = uiSlice.actions;
